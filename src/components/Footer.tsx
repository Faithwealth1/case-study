...
export const Footer: React.FC = () => {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Support portals', href: '#support' },
        { label: 'Contact us', href: '#contact' }
      ]
    },
    {
  ...
  return (
    <footer className="flex w-full flex-col justify-center items-start gap-2.5 bg-[#0A0919] pt-10 pb-[110px] max-md:pt-10 max-md:pb-20 max-sm:pt-[30px] max-sm:pb-[60px] overflow-x-hidden">
      <div className="flex items-start self-stretch max-w-screen-xl w-full mx-auto my-0 px-20 max-md:px-10 max-sm:px-5 gap-[120px] max-md:flex-col max-md:gap-10 max-sm:gap-[30px]">
